...
<BreadcrumbSchema
  items={[
    { name: 'Codenetic', item: 'https://codenetic.tech' },
    { name: 'Blog', item: 'https://codenetic.tech/blog' },
    { name: 'Marketing Tools', item: 'https://codenetic.tech/blog/Latest-News' },
    { name: '20+ Best Digital Marketing Tools in 2024' } // no item field for the last breadcrumb
  ]}
/>

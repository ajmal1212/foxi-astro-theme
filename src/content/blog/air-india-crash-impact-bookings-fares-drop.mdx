...
export const pageTitle = 'Air India Crash Triggers 20% Drop in Bookings and 15% Fare Dip Across Routes'
...
<NewsSchema
  ...
  image={["https://codenetic.tech/blog/12.webp"]}
...
<BreadcrumbSchema
  items={[
    { name: 'Latest News', item: `https://codenetic.tech/blog/latest-news` },
    { name: pageTitle, item: `https://codenetic.tech/blog/latest-news/air-india-crash-impact-bookings-fares-drop` }
  ]}
/>
  ...
  <table class="min-w-full border-separate border-spacing-y-2 text-sm text-left">
    <thead>
      <tr class="bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300">
        <th class="px-5 py-3 rounded-l-xl">Route Type</th>
        <th class="px-5 py-3 rounded-r-xl">Fare Reduction Range</th>
      </tr>
    </thead>
    <tbody>
      <tr class="bg-white dark:bg-zinc-900 text-zinc-800 dark:text-zinc-100 shadow-sm hover:shadow-md transition rounded-xl">
        <td class="px-5 py-3 rounded-l-xl">Domestic Routes</td>
        <td class="px-5 py-3 rounded-r-xl">8% – 12%</td>
      </tr>
      <tr class="bg-white dark:bg-zinc-900 text-zinc-800 dark:text-zinc-100 shadow-sm hover:shadow-md transition rounded-xl">
        <td class="px-5 py-3 rounded-l-xl">International Routes</td>
        <td class="px-5 py-3 rounded-r-xl">10% – 15%</td>
      </tr>
    </tbody>
  </table>
</div>
